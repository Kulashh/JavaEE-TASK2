    ...
    <div class="container">
        ...
        <div style="width: 50%">
            ...
            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#exampleModalDelete">
                ...
                <!-- Modal -->
                <div class="modal fade" id="exampleModalDelete" tabindex="-1" aria-labelledby="exampleModal" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="/deleteItem" method="post">
                                <div class="modal-body">
                                    <input name="id" type="text" value=value="<%=item.getId()%>">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="/urdateItem" method="post">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">NAME</label>
